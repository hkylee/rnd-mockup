...
// source spec:  docs/input/components/json/accordion-price-info.json
// source DS:    skt-design-system.json
// generated at: 2026-05-19T05:53:14.440Z
...
async function generateComponentSet(spec, tokens) {
  ...
  const firstSeg = spec.name.split("/")[0];
  const category = (firstSeg === spec.name) ? (spec.category || firstSeg) : firstSeg;
  if (category === "page") {
    return generateScreen(spec, tokens, fontResult);
  }
  const pageMap = { atom: "Components", mol: "Components", ogn: "Components", sb: "SB", component: "Components" };
