...
// name: atom/icon/chevron-down / svg: Heroicons/chevron-down-micro.svg
...
export function ChevronDown(props: ChevronDownProps = {} as ChevronDownProps) {
  return (
    <svg
      data-component="atom/icon/chevron-down"
