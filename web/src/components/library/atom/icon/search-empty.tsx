...
// name: atom/icon/search-empty / svg: Heroicons/magnifying-glass-circle-micro.svg
...
export function SearchEmpty(props: SearchEmptyProps = {} as SearchEmptyProps) {
  return (
    <svg
      data-component="atom/icon/search-empty"
