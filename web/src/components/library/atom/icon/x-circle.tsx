...
// name: atom/icon/x-circle / svg: Heroicons/x-circle-micro.svg
...
export function XCircle(props: XCircleProps = {} as XCircleProps) {
  return (
    <svg
      data-component="atom/icon/x-circle"
