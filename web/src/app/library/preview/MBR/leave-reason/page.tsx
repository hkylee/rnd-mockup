...
import { CheckboxItem } from "@/components/library/mol/checkbox-item";
import { TextArea } from "@/components/library/atom/text-area";
...
export default function PreviewPage() {
  ...
  const [s_reason_1, set_s_reason_1] = React.useState<boolean>(false);
  const [s_reason_2, set_s_reason_2] = React.useState<boolean>(false);
  const [s_reason_3, set_s_reason_3] = React.useState<boolean>(false);
  const [s_reason_4, set_s_reason_4] = React.useState<boolean>(false);
  const [s_reason_5, set_s_reason_5] = React.useState<boolean>(false);
  ...
  return (
    <PageStateContext.Provider value={{ "reason-1": s_reason_1, "reason-2": s_reason_2, "reason-3": s_reason_3, "reason-4": s_reason_4, "reason-5": s_reason_5 }}>
    <div style={embed ? { minHeight: "100vh", background: "#fff", display: "flex", justifyContent: "center", alignItems: "flex-start", padding: 0 } : { minHeight: "100vh", background: "#1f2937", display: "flex", justifyContent: "center", alignItems: "flex-start", padding: 32 }}>
      <div style={embed ? { width: 375, height: 812, background: "var(--semantic-color-background-page-home, #ffffff)", overflow: "hidden", display: "flex", flexDirection: "column" } : { width: 375, height: 812, background: "var(--semantic-color-background-page-home, #ffffff)", borderRadius: 24, overflow: "hidden", boxShadow: "0 8px 24px rgba(0,0,0,0.2)", display: "flex", flexDirection: "column" }}>
        <div data-component="page/MBR/leave-reason" style={{ ...{ display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", gap: "var(--foundation-dimension-spacing-none)", paddingTop: "var(--foundation-dimension-spacing-none)", paddingRight: "var(--foundation-dimension-spacing-none)", paddingBottom: "var(--foundation-dimension-spacing-none)", paddingLeft: "var(--foundation-dimension-spacing-none)", width: "100%", height: "var(--foundation-dimension-size-screen-mobile-height)", background: "var(--semantic-color-background-page-sub)", minHeight: "100%" }, height: "100%", overflowY: "auto", overflowX: "hidden" }} onClick={(e) => {
          ...
          const _stateKeys = new Set<string>(["reason-1","reason-2","reason-3","reason-4","reason-5"]);
          ...
          if (id) {
          if (id === "reason-1") { set_s_reason_1(v => !v); return; }
          if (id === "reason-2") { set_s_reason_2(v => !v); return; }
          if (id === "reason-3") { set_s_reason_3(v => !v); return; }
          if (id === "reason-4") { set_s_reason_4(v => !v); return; }
          if (id === "reason-5") { set_s_reason_5(v => !v); return; }
          }
          ...
          <Header data-id="header" {...{"title": "회원 탈퇴"}} />
          ...
          <div data-id="content" style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", gap: "var(--foundation-dimension-spacing-lg)", paddingTop: "var(--foundation-dimension-spacing-lg)", paddingRight: "var(--foundation-dimension-spacing-none)", paddingBottom: "var(--foundation-dimension-spacing-none)", paddingLeft: "var(--foundation-dimension-spacing-none)", width: "100%", height: "auto", alignSelf: "stretch", flex: "1 1 0%", minWidth: 0 }}>
            <div data-id="headline-wrap" style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", gap: "var(--foundation-dimension-spacing-none)", paddingTop: "var(--foundation-dimension-spacing-none)", paddingRight: "var(--semantic-layout-screen-padding-default)", paddingBottom: "var(--foundation-dimension-spacing-none)", paddingLeft: "var(--semantic-layout-screen-padding-default)", width: "100%", height: "auto", alignSelf: "stretch" }}>
              <SectionHeader data-id="section-headline" {...{"headline": "탈퇴 사유를 알려주세요", "description": "더 나은 서비스를 만드는 데 도움이 됩니다."}} style={{ alignSelf: "stretch" }} />
            </div>
            <div data-id="reason-list" style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", gap: "var(--component-checkbox-list-default-itemspacing)", paddingTop: "var(--component-checkbox-list-default-paddingy)", paddingRight: "var(--component-checkbox-list-default-paddingx)", paddingBottom: "var(--component-checkbox-list-default-paddingy)", paddingLeft: "var(--component-checkbox-list-default-paddingx)", width: "100%", height: "auto", alignSelf: "stretch" }}>
              <CheckboxItem data-id="reason-1" {...{"checked": s_reason_1, "label": "사용 빈도가 낮아요", "input": "radio", "tone": "none", "action": "without"}} />
              <CheckboxItem data-id="reason-2" {...{"checked": s_reason_2, "label": "다른 서비스를 이용해요", "input": "radio", "tone": "none", "action": "without"}} />
              <CheckboxItem data-id="reason-3" {...{"checked": s_reason_3, "label": "개인정보가 우려돼요", "input": "radio", "tone": "none", "action": "without"}} />
              <CheckboxItem data-id="reason-4" {...{"checked": s_reason_4, "label": "서비스 만족도가 낮아요", "input": "radio", "tone": "none", "action": "without"}} />
              <CheckboxItem data-id="reason-5" {...{"checked": s_reason_5, "label": "기타", "input": "radio", "tone": "none", "action": "without"}} />
              <TextArea data-id="etc-text-area" style={{ alignSelf: "stretch" }} />
            </div>
          </div>
