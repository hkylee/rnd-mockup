  ...
  return (
    ...
    <div style={embed ? { minHeight: "100vh", background: "#fff", display: "flex", justifyContent: "center", alignItems: "flex-start", padding: 0 } : { minHeight: "100vh", background: "#1f2937", display: "flex", justifyContent: "center", alignItems: "flex-start", padding: 32 }}>
      <div style={embed ? { width: 375, height: 812, background: "var(--semantic-color-background-page-home, #ffffff)", overflow: "hidden", display: "flex", flexDirection: "column" } : { width: 375, height: 812, background: "var(--semantic-color-background-page-home, #ffffff)", borderRadius: 24, overflow: "hidden", boxShadow: "0 8px 24px rgba(0,0,0,0.2)", display: "flex", flexDirection: "column" }}>
        <div data-component="page/MBR/leave-complete" style={{ ...{ display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", gap: "var(--foundation-dimension-spacing-none)", paddingTop: "var(--foundation-dimension-spacing-none)", paddingRight: "var(--foundation-dimension-spacing-none)", paddingBottom: "var(--foundation-dimension-spacing-none)", paddingLeft: "var(--foundation-dimension-spacing-none)", width: "100%", height: "var(--foundation-dimension-size-screen-mobile-height)", background: "var(--semantic-color-background-page-sub)", minHeight: "100%" }, height: "100%", overflowY: "auto", overflowX: "hidden" }} onClick={(e) => {
          ...
          <div data-id="content" style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", gap: "var(--foundation-dimension-spacing-none)", paddingTop: "var(--foundation-dimension-spacing-none)", paddingRight: "var(--foundation-dimension-spacing-none)", paddingBottom: "var(--foundation-dimension-spacing-none)", paddingLeft: "var(--foundation-dimension-spacing-none)", width: "100%", height: "auto", alignSelf: "stretch", flex: "1 1 0%", minWidth: 0 }}>
            <ResultSummary data-id="result" {...{"headline": "탈퇴가 완료되었습니다", "description": "유예 종료일까지 탈퇴를 철회하실 수 있습니다.", "sub-info": "유예 종료까지 D-7", "tone": "calm"}} style={{ alignSelf: "stretch" }} />
            <div data-id="notice-wrap" style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", gap: "var(--foundation-dimension-spacing-md)", paddingTop: "var(--foundation-dimension-spacing-none)", paddingRight: "var(--semantic-layout-screen-padding-default)", paddingBottom: "var(--foundation-dimension-spacing-lg)", paddingLeft: "var(--semantic-layout-screen-padding-default)", width: "100%", height: "auto", alignSelf: "stretch" }}>
              <NoticeCard data-id="recall-notice" {...{"message": "그 전까지 1:1 문의로 탈퇴를 철회하실 수 있어요.", "type": "message"}} style={{ alignSelf: "stretch" }} />
              <NoticeCard data-id="data-notice" {...{"message": "일부 데이터는 법령에 따라 정해진 기간 동안 보관됩니다.", "type": "message"}} style={{ alignSelf: "stretch" }} />
            </div>
          </div>
          <StickyFooterCta data-id="sticky-footer" {...{"label": "확인"}} style={{ alignSelf: "stretch", position: "sticky", bottom: 0, zIndex: 10 }} />
