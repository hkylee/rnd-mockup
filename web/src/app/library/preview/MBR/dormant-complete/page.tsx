...
// spec: page/MBR/dormant-complete
"use client";
...
import { ResultSummary } from "@/components/library/ogn/MBR/result-summary";
import { NoticeCard } from "@/components/library/mol/notice-card";
import { PostActions } from "@/components/library/ogn/MBR/post-actions";
...
const SLUG = "MBR/dormant-complete";
  ...
  return (
    ...
    <div style={embed ? { minHeight: "100vh", background: "#fff", display: "flex", justifyContent: "center", alignItems: "flex-start", padding: 0 } : { minHeight: "100vh", background: "#1f2937", display: "flex", justifyContent: "center", alignItems: "flex-start", padding: 32 }}>
      <div style={embed ? { width: 375, height: 812, background: "var(--semantic-color-background-page-home, #ffffff)", overflow: "hidden", display: "flex", flexDirection: "column" } : { width: 375, height: 812, background: "var(--semantic-color-background-page-home, #ffffff)", borderRadius: 24, overflow: "hidden", boxShadow: "0 8px 24px rgba(0,0,0,0.2)", display: "flex", flexDirection: "column" }}>
        <div data-component="page/MBR/dormant-complete" style={{ ...{ display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", gap: "var(--foundation-dimension-spacing-none)", paddingTop: "var(--foundation-dimension-spacing-none)", paddingRight: "var(--foundation-dimension-spacing-none)", paddingBottom: "var(--foundation-dimension-spacing-none)", paddingLeft: "var(--foundation-dimension-spacing-none)", width: "100%", height: "var(--foundation-dimension-size-screen-mobile-height)", background: "var(--semantic-color-background-page-sub)", minHeight: "100%" }, height: "100%", overflowY: "auto", overflowX: "hidden" }} onClick={(e) => {
          ...
          <div data-id="content" style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", gap: "var(--foundation-dimension-spacing-none)", paddingTop: "var(--foundation-dimension-spacing-none)", paddingRight: "var(--foundation-dimension-spacing-none)", paddingBottom: "var(--foundation-dimension-spacing-none)", paddingLeft: "var(--foundation-dimension-spacing-none)", width: "100%", height: "auto", alignSelf: "stretch", flex: "1 1 0%", minWidth: 0 }}>
            <ResultSummary data-id="result" {...{"headline": "다시 돌아오신 것을 환영합니다", "description": "정상 이용이 재개되었습니다. 이전 정보를 확인해 보세요.", "tone": "re-welcome"}} style={{ alignSelf: "stretch" }} />
            <div data-id="scope-wrap" style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", gap: "var(--foundation-dimension-spacing-none)", paddingTop: "var(--foundation-dimension-spacing-none)", paddingRight: "var(--semantic-layout-screen-padding-default)", paddingBottom: "var(--foundation-dimension-spacing-lg)", paddingLeft: "var(--semantic-layout-screen-padding-default)", width: "100%", height: "auto", alignSelf: "stretch" }}>
              <NoticeCard data-id="scope-card" {...{"message": "회원 정보, 이전 이용 내역, 일부 혜택이 복원되었습니다.", "type": "message"}} style={{ alignSelf: "stretch" }} />
            </div>
            <PostActions data-id="post-actions" style={{ alignSelf: "stretch" }} />
          </div>
          <StickyFooterCta data-id="sticky-footer" {...{"label": "홈으로"}} style={{ alignSelf: "stretch", position: "sticky", bottom: 0, zIndex: 10 }} />
