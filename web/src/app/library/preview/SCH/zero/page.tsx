...
import { EmptyHero } from "@/components/library/ogn/SCH/empty-hero";
import { NoticeCard } from "@/components/library/mol/notice-card";
import { KeywordChips } from "@/components/library/ogn/SCH/keyword-chips";
import { CategoryCard } from "@/components/library/ogn/SCH/category-card";
  ...
  return (
    ...
    <div style={embed ? { minHeight: "100vh", background: "#fff", display: "flex", justifyContent: "center", alignItems: "flex-start", padding: 0 } : { minHeight: "100vh", background: "#1f2937", display: "flex", justifyContent: "center", alignItems: "flex-start", padding: 32 }}>
      <div style={embed ? { width: 375, height: 812, background: "var(--semantic-color-background-page-home, #ffffff)", overflow: "hidden", display: "flex", flexDirection: "column" } : { width: 375, height: 812, background: "var(--semantic-color-background-page-home, #ffffff)", borderRadius: 24, overflow: "hidden", boxShadow: "0 8px 24px rgba(0,0,0,0.2)", display: "flex", flexDirection: "column" }}>
        <div data-component="page/SCH/zero" style={{ ...{ display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", gap: "var(--foundation-dimension-spacing-none)", paddingTop: "var(--foundation-dimension-spacing-none)", paddingRight: "var(--foundation-dimension-spacing-none)", paddingBottom: "var(--foundation-dimension-spacing-none)", paddingLeft: "var(--foundation-dimension-spacing-none)", width: "100%", height: "var(--foundation-dimension-size-screen-mobile-height)", background: "var(--semantic-color-background-page-sub)", minHeight: "100%" }, height: "100%", overflowY: "auto", overflowX: "hidden" }} onClick={(e) => {
          ...
          <SearchBar data-id="search-bar" {...{"placeholder": "존재하지 않는 검색어"}} style={{ alignSelf: "stretch", position: "sticky", bottom: 0, zIndex: 10 }} />
          <div data-id="content" style={{ display: "flex", flexDirection: "column", justifyContent: "flex-start", alignItems: "flex-start", gap: "var(--foundation-dimension-spacing-2xl)", paddingTop: "var(--semantic-layout-screen-padding-default)", paddingRight: "var(--semantic-layout-screen-padding-default)", paddingBottom: "var(--semantic-layout-screen-padding-default)", paddingLeft: "var(--semantic-layout-screen-padding-default)", width: "100%", height: "auto", alignSelf: "stretch", flex: "1 1 0%", minWidth: 0 }}>
            <EmptyHero data-id="section-empty-hero" style={{ alignSelf: "stretch" }} />
            <NoticeCard data-id="typo-correction" {...{"message": "혹시 '존재하는 검색어' 를 찾으셨나요?  탭하여 재검색", "type": "plain"}} style={{ alignSelf: "stretch" }} />
            <KeywordChips data-id="section-similar" {...{"label": "이런 검색어는 어떠세요", "type": "similar"}} style={{ alignSelf: "stretch" }} />
            <CategoryCard data-id="section-categories" style={{ alignSelf: "stretch" }} />
            <NoticeCard data-id="cs-cta" {...{"title": "원하는 결과가 없으신가요?", "body": "상담사가 빠르게 도와드릴게요. 1:1 채팅으로 문의해 주세요.", "type": "title-body"}} style={{ alignSelf: "stretch" }} />
          </div>
