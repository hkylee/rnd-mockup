// =============================================
// AUTO-GENERATED — BATCH MODE (--group atom)
// atom category 만 통합 (+ icon)
// specs: 13개 / icons: 37개
// generated at: 2026-05-18T08:09:38.737Z
// =============================================
...
const SPECS = [
  {
    ...
    "name": "atom/badge",
    "category": "atom",
    "description": "뱃지. Gray/Blue/Black 타입.",
    "base": {
      "layout": {
        "mode": "HORIZONTAL",
        "itemSpacing": 10,
  ...
  },
  {
    ...
    "name": "atom/btn",
    "category": "atom",
    "description": "버튼. Size(Small~XLarge) × Type(Primary/Secondary/Disabled). LeftItem 슬롯.",
    "base": {
      "layout": {
        "mode": "HORIZONTAL",
        "itemSpacing": 10,
  ...
  {
    "$schema": "component-spec-v1",
    "name": "atom/btn-xsmall",
    "category": "atom",
    "description": "소형 솔리드 버튼. Active/Disabled.",
    "base": {
      "layout": {
        "mode": "HORIZONTAL",
        "paddingTop": 4,
  ...
  },
  {
    ...
    "name": "atom/checkbox",
    "category": "atom",
    "description": "체크박스. On/Off × Disabled 상태.",
    "base": {
      "layout": {
        "mode": "HORIZONTAL",
        "itemSpacing": 10,
  ...
  },
  {
    ...
    "name": "atom/chip",
    "category": "atom",
    "description": "텍스트 칩. Selected On/Off.",
    "base": {
      "layout": {
        "mode": "HORIZONTAL",
        "itemSpacing": 2,
  ...
  {
    "$schema": "component-spec-v1",
    "name": "atom/chip-image",
    "category": "atom",
    "description": "이미지+텍스트 칩. Selected On/Off.",
    "base": {
      "layout": {
        "mode": "HORIZONTAL",
        "itemSpacing": 2,
  ...
  },
  {
    ...
    "name": "atom/divider",
    "category": "atom",
    "description": "구분선. Contents(얇음) / Section(두꺼움) 타입.",
    "base": {
      "layout": {
        "mode": "VERTICAL",
        "itemSpacing": 10,
  ...
  },
  {
    ...
    "name": "atom/icon",
    "category": "atom",
    "description": "아이콘 시스템. Size(12~40) × Name × Type(방향) × Fill 조합.",
    "base": {
      "layout": {
        "mode": "HORIZONTAL",
        "itemSpacing": 10,
  ...
  {
    "$schema": "component-spec-v1",
    "name": "atom/payment-logo",
    "category": "atom",
    "description": "결제 수단 로고 아이템.",
    "base": {
      "layout": {
        "mode": "HORIZONTAL",
        "paddingTop": 2,
  ...
  },
  {
    ...
    "name": "atom/radio",
    "category": "atom",
    "description": "라디오 버튼. On/Off × Disabled 상태.",
    "base": {
      "layout": {
        "mode": "HORIZONTAL",
        "itemSpacing": 10,
  ...
  },
  {
    ...
    "name": "atom/tab-item",
    "category": "atom",
    "description": "탭 아이템 단위. Default/Selected.",
    "base": {
      "layout": {
        "mode": "VERTICAL",
        "itemSpacing": 12,
